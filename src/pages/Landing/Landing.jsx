...
// Move safety features outside component for performance
const SAFETY_FEATURES = [
  ...
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#F07B3A]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M13 1h-2v2H9v2H7v2H5v2H3v2H1v2h2v2h2v2h2v2h2v2h2v2h2v2h2v-2h2v-2h2v-2h2v-2h-2v-2h2v-2h2v-2h-2V7h-2V5h-2V3h-2V1zm0 6h2v2h-2V7zm0 4h2v2h-2v7zm-4-4h2v2H9V7zm0 4h2v2H9v11z"/>
      </svg>
    ),
    title: "SOS Emergency",
  ...
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#F07B3A]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l12 17.27z"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3DBDA8]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 1c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2s2-.9 2-2 2-2 .9-2 2-2zm0 16c2.76 0 5-2.24 5-5V9h-2v3c0 1.66-1.34 3-3 3s-3-1.34-3-3-3 3c0 2.76 2.24 5 5 5zm6-10v1h-2V7h2z"/>
      </svg>
    ),
    title: "24/7 Support",
...
const HeroSection = memo(({ navigate }) => (
...
const HeroButtons = memo(({ navigate }) => (
  <div className="reveal delay-4 flex flex-wrap gap-3 mb-10">
    <button 
      onClick={() => navigate('/signup')} 
      className="btn-glow font-bold text-sm px-7 py-3.5 rounded-2xl inline-flex items-center gap-2"
    ...
    <button 
      ...
      className="btn-teal text-sm px-7 py-3.5 rounded-2xl inline-flex items-center gap-2"
      aria-label="See how it works"
    >
      <span className="icon" style={{ fontSize: '17px', color: '#2A9E8C' }}>play_circle</span>
      See how it works
    </button>
  </div>
));
  ...
  <section className="py-24 px-4 sm:px-6 bg-[#F7F7F5] section-divider" id="how">
    <div className="max-w-5xl mx-auto">
      <div className="flex flex-col items-center text-center mb-14">
        <span className="section-label text-[#F07B3A] mb-3">How it works</span>
      ...
      <div className="grid md:grid-cols-3 gap-5">
        <div className="card-lift relative bg-white border border-black/7 rounded-3xl p-7 shadow-sm">
          <div className="w-11 h-11 rounded-2xl bg-[#FFF3EC] border border-[#F07B3A]/20 flex items-center justify-center mb-5">
            <svg className="w-6 h-6 text-[#F07B3A]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>
            </svg>
          </div>
        ...
        <div className="card-lift relative bg-white border border-black/7 rounded-3xl p-7 shadow-sm">
          <div className="w-11 h-11 rounded-2xl bg-[#FFF3EC] border border-[#F07B3A]/20 flex items-center justify-center mb-5">
            <svg className="w-6 h-6 text-[#F07B3A]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 1.99 2H20c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4v2h16V6z"/>
            </svg>
          </div>
...
const Safety = memo(() => <SafetyCard />);
Safety.displayName = 'Safety';

const Testimonials = memo(() => <TestimonialCard />);
