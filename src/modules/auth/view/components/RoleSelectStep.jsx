...
//   return (
//     <div id="step-role" className="opacity-1 transform translate-x-0 transition-opacity duration-300 ease-out transition-transform duration-300 ease-out">

//       <div className="text-center mb-8">
//         <p className="text-xs font-semibold text-[#111]/30 tracking-widest uppercase mb-3">Step 1 of 3</p>
//         <h1 className="text-3xl sm:text-4xl text-[#111] mb-2">Join Campus Share-All</h1>
//         <p className="text-[#111]/45 text-sm">Choose your role to get started</p>
//       </div>

//       {/* 3 role cards */}
//       <div className="grid grid-cols-3 gap-3 mb-6">
//         {Object.entries(roleConfig).map(([key, config]) => (
//           <div key={key} className={`rcard ${selectedRole === key ? selClass[key] : ''}`} onClick={() => onSelectRole(key)}>
//             <div className="tick">
//               <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
//                 <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
//               </svg>
//             </div>
//             <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-3`} style={{ backgroundColor: `${config.bg}20` }}>
//               <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: config.bg }}>
//                 <path d={iconPaths[key]} />
//               </svg>
//             </div>
//             <p className="font-bold text-sm text-[#111] mb-1">{config.label}</p>
//             <p className="text-[10px] text-[#111]/40 leading-relaxed">{config.hint.split(',')[0]}</p>
//           </div>
//         ))}
//       </div>
...
//         >
//           {selectedRole ? `Continue as ${roleConfig[selectedRole].label}` : 'Select a role to continue'}
//           {selectedRole && (
...
//       <div>
//         <button className="btn-g" onClick={() => window.location.href = 'verify.html'}>
