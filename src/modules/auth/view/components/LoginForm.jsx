        ...
        <div className="flex flex-1">
          ...
          <div className="flex-1 flex items-start justify-center px-5 sm:px-8 py-10">
            <div className="w-full max-w-[420px]">
              ...
              {/* Google OAuth */}
              <button className="w-full h-[48px] border border-black/10 rounded-xl font-semibold text-sm flex items-center justify-center gap-3 bg-white hover:border-black/18 transition-colors mb-5">
