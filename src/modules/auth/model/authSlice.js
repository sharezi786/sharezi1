...
const authSlice = createSlice({
  name: "auth",
  initialState: {
    user:     { id: "u1", name: "Arjun Sharma", email: "arjun@university.edu", college: "Delhi University" },
    token:    "dev_token",
...
export const { setCredentials, setVerified, setLoading, setError, logout } = authSlice.actions;
