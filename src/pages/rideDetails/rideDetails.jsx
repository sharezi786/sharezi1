    ...
    <div className="flex flex-col h-screen bg-[#F7F7F5] relative font-sans">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        <div className="max-w-xl mx-auto flex flex-col gap-4">
          ...
          <div className="map-area rounded-2xl h-48 relative overflow-hidden bg-[#E8F0F8]">
            ...
            <svg width="100%" height="100%" className="absolute inset-0 opacity-20">
              <defs>
                <pattern id="grid" width="28" height="28" patternUnits="userSpaceOnUse">
                  <path d="M 28 0 L 0 0 0 28" fill="none" stroke="rgba(61,189,168,.5)" strokeWidth=".5"/>
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#grid)"/>
            </svg>
            {/* Route SVG */}
            <svg className="absolute inset-0" width="100%" height="100%" viewBox="0 0 500 180" preserveAspectRatio="none">
              <path d="M 60 150 C 120 130 160 100 220 80 C 280 60 340 50 440 40" fill="none" stroke="#F07B3A" strokeWidth="3" strokeDasharray="8,5" strokeLinecap="round" opacity=".8"/>
              {/* Start dot */}
            ...
            {/* Labels */}
            <div className="absolute bottom-4 left-5 bg-white/90 backdrop-blur rounded-xl px-2.5 py-1 text-xs font-semibold text-[#3DBDA8] shadow-sm">IITB Gate 1</div>
            <div className="absolute top-4 right-5 bg-white/90 backdrop-blur rounded-xl px-2.5 py-1 text-xs font-semibold text-[#F07B3A] shadow-sm">Andheri Station</div>
          ...
          <div className="bg-white border border-black/7 rounded-2xl p-4">
            <div className="flex items-center gap-4">
              <div className="relative shrink-0">
                <div className="w-14 h-14 rounded-2xl bg-[#3DBDA8] flex items-center justify-center text-white text-xl font-bold">{ride.name[0]}</div>
                {ride.verified && (
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm font-bold text-[#111]">{ride.rating}</span>
                    <span className="text-sm text-[#111]/35">({ride.rides} rides)</span>
                  </div>
                </div>
              </div>
              <button onClick={openMessage} className="bg-[#3DBDA8] text-white text-xs font-semibold h-8 rounded-lg flex items-center gap-1 px-3 shrink-0 hover:bg-[#2AA898]">
                <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#111]/40">{ride.vehicle.split(' · ').slice(1).join(' · ')}</p>
              </div>
              <div className="ml-auto flex gap-1.5">
                <span className="bg-[#F3EFFE] text-[#7C3AED] text-xs font-bold px-2 py-1 rounded-full">{ride.gender}</span>
                <span className="bg-[#EAF9F7] text-[#2A9E8C] text-xs font-bold px-2 py-1 rounded-full">Prepaid</span>
              </div>
            </div>
          </div>
          ...
          {/* Route Info */}
          <div className="bg-white border border-black/7 rounded-2xl p-4">
            <p className="text-xs font-bold text-[#111]/35 uppercase tracking-widest mb-3">Route</p>
            <div className="flex gap-3">
              ...
              <div className="flex flex-col justify-between flex-1 min-h-[56px]">
                <div>
                  <p className="text-sm font-semibold text-[#111]">{ride.from}</p>
          ...
          {/* Price Breakdown */}
          <div className="bg-white border border-black/7 rounded-2xl p-4">
            <p className="text-xs font-bold text-[#111]/35 uppercase tracking-widest mb-2">Price Breakdown</p>
            <div className="flex items-center justify-between py-2.5 text-sm">
              <span className="text-[#111]/55">Ride fare (1 seat)</span>
              <span className="font-semibold text-[#111]">₹{ride.price}.00</span>
            </div>
            <div className="flex items-center justify-between py-2.5 text-sm">
              <span className="text-[#111]/55">Platform fee</span>
              <span className="font-semibold text-[#111]">₹{ride.platformFee}.00</span>
            </div>
            <div className="flex items-center justify-between py-2.5 text-sm">
              <span className="text-[#111]/55">Promo (CAMPUS3)</span>
              <span className="font-semibold text-[#3DBDA8]">–₹{ride.promo}.00</span>
            </div>
            <div className="flex items-center justify-between py-2.5 text-sm border-t-2 border-black/10 pt-3 mt-1">
              ...
              <span style={{fontFamily:'Syne'}} className="text-lg font-black text-[#F07B3A]">₹{ride.total}.00</span>
            </div>
            <div className="mt-3 flex items-center gap-2 bg-[#F7F7F5] rounded-xl p-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#111]/40">Balance: ₹{ride.walletBalance}</p>
              </div>
              <button className="text-xs text-[#F07B3A] font-semibold hover:underline">Change</button>
            </div>
          </div>

          {/* Safety Info */}
          <div className="bg-white border border-black/7 rounded-2xl p-4">
            <p className="text-xs font-bold text-[#111]/35 uppercase tracking-widest mb-3">Safety</p>
            <div className="flex flex-col gap-2.5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#111]/40">Student ID + licence confirmed</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#EAF9F7] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#111]/40">Share your trip with a trusted contact</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#111]/40">Available during your ride</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-60 flex items-end justify-center">
          <div className="absolute inset-0 bg-black/45" onClick={closeConfirm}></div>
          <div className="relative z-1 bg-white border-t-4 border-t-white rounded-t-3xl p-4 w-full max-w-[540px]">
            ...
            <p className="text-sm text-[#111]/45 mb-5">Review your booking details before confirming.</p>

            <div className="bg-[#F7F7F5] rounded-2xl p-4 mb-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-[#3DBDA8] flex items-center justify-center text-white font-bold shrink-0">{ride.name[0]}</div>
                <div>
                  <p className="text-sm font-bold text-[#111]">{ride.name}</p>
                  <p className="text-xs text-[#111]/40">{ride.vehicle.split(' · ')[0]} · {ride.vehicle.split(' · ')[1]}</p>
                </div>
                <div className="ml-auto text-right">
                  <span style={{fontFamily:'Syne'}} className="text-lg font-black text-[#F07B3A]">₹{ride.total}</span>
            ...
            <div className="flex items-center gap-3 mb-5 bg-[#EAF9F7] rounded-xl p-3">
              ...
              <div>
                <p className="text-sm font-semibold text-[#111]">Pay from Wallet</p>
                <p className="text-xs text-[#111]/40">₹{ride.walletBalance} → ₹{ride.walletBalance - ride.total} after booking</p>
              </div>
              <span className="ml-auto text-xs font-bold text-[#3DBDA8]">₹{ride.total}</span>
            </div>

            <div className="flex gap-3">
              <button onClick={closeConfirm} className="flex-1 bg-white text-[#111] font-semibold text-sm h-12 rounded-xl border border-black/12 flex items-center justify-center hover:border-black/22 transition-all">
                Cancel
              </button>
              <button onClick={confirmBooking} disabled={confirming} className="flex-1 bg-[#F07B3A] text-white font-bold text-sm h-12 rounded-xl flex items-center justify-center gap-2 shadow-[0_4px_16px_rgba(240,123,58,.28)] hover:shadow-[0_8px_24px_rgba(240,123,58,.38)] hover:-translate-y-0.5 transition-all disabled:opacity-50">
                {confirming ? (
            ...
            <p className="text-center text-[10px] text-[#111]/30 mt-3">Payment is processed in-app only. No cash.</p>
          </div>
        </div>
      )}
      ...
      {showMessage && (
        <div className="fixed inset-0 z-60 flex items-end justify-center">
          <div className="absolute inset-0 bg-black/45" onClick={closeMessage}></div>
          <div className="relative z-1 bg-white border-t-4 border-t-white rounded-t-3xl p-4 w-full max-w-[540px]">
            <div className="w-10 h-1 bg-black/10 rounded-full mx-auto mb-4"></div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-[#3DBDA8] flex items-center justify-center text-white font-bold">{ride.name[0]}</div>
              <div>
                <p className="text-sm font-bold text-[#111]">{ride.name}</p>
